...
namespace utl {
    ...
    MessageLooperWin::MessageLooperWin() {
    ...
    void MessageLooperWin::wakeup() {
        ::SetEvent(event_);
    }

    void MessageLooperWin::loop() {
        for (;;) {
    ...
    void MessageLooperWin::wait(int64_t delay) {
    ...
    bool MessageLooperWin::platformWork() {
        /*
